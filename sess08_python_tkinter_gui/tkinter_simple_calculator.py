...
label_operator = tk.Label(frame, text="Operator (=, -, x, /)")
label_operator.grid(row=1, column=0, padx=10, pady=10, sticky='e')
...
input_width = 25 # same input for all input controls/widgets

# Entry widgets and conbobox
...
operation_choices = ['+', '-', '/', '*' ] # List of arithmetic operations for the combobox
...
entry.operation.set("Select Operation") # Default value for the combobox/dropdown list

entry_second = ttk.Entry(frame, width=input_width)
